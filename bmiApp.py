...
st.write("กรอกข้อมูลน้ำหนักและส่วนสูงของคุณ ้พื่อเช็กสุขภาพเบื้องต้น")

#ส่วนที่ 2 สร้างช่องรับค่าน้ำหนัก และ ส่วนสูง
weight = st.number_input("️‍🔥กรอกน้ำหนักของคุณ (กิโลกรัม):")
height_cm = st.number_input("⭐กรอกส่วนสูงของคุณ(เซนติเมตร):")

#ส่วนที่ 3 สร้างปุ่มกดคำถาม
if st.button("คำนวณค่า BMI🩺❤️"):
  height_m = height_cm / 100
  bmi = weight / (height_m ** 2)

st.write("---")
st.header(f"⚖️ค่า BMI ของคุณคือ: **{bmi:.2f}**")
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
 if bmi < 18.5:
   ...
   st.eror("⚠️คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย") 
