...
weight = st.number_input("กรอกน้ำหนักของคุณ (กิโลกรัม):", value=1.0)
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):", value=1.0)
...
st.divider()
st.write("นางสาวกมลลักษณ์ แซ่ตวน เลขที่11 ม.4/6")
